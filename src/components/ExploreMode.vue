...
<template>
  <div ref="exploreRef" class="flex-1 overflow-y-auto relative z-10">
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-8 pt-8 pb-16 sm:pt-12 sm:pb-20">
      ...
      <section :id="chapters[0].id" class="pb-32">
        ...
        <!-- 1.1 核心定义 -->
        <div :id="chapters[0].subs[0].id" class="mb-20 scroll-mt-32">
        ...
        <!-- 1.2 发展简史 -->
        <div :id="chapters[0].subs[1].id" class="mb-20 scroll-mt-32">
          <div class="reveal flex items-center gap-3 mb-5" style="opacity:0;transform:translateY(20px)">
        ...
        <!-- 1.3 三种层级 -->
        <div :id="chapters[0].subs[2].id" class="mb-20 scroll-mt-32">
          <div class="reveal flex items-center gap-3 mb-5" style="opacity:0;transform:translateY(20px)">
        ...
        <!-- 1.4 AI vs 人类智能 -->
        <div :id="chapters[0].subs[3].id" class="mb-20 scroll-mt-32">
          <div class="reveal flex items-center gap-3 mb-5" style="opacity:0;transform:translateY(20px)">
        ...
        <!-- 1.5 常见误解 -->
        <div :id="chapters[0].subs[4].id" class="scroll-mt-32">
          <div class="reveal flex items-center gap-3 mb-5" style="opacity:0;transform:translateY(20px)">
      ...
      <section :id="chapters[1].id" class="pb-32 scroll-mt-32">
        ...
        <!-- 2.1 -->
        <div :id="chapters[1].subs[0].id" class="mb-20 scroll-mt-32">
          <div class="reveal flex items-center gap-3 mb-5" style="opacity:0;transform:translateY(20px)">
  ...
  F -.->|未达标,调整特征| D`"
        ...
        <!-- 2.2 神经网络的秘密 -->
        <div :id="chapters[1].subs[1].id" class="scroll-mt-32">
          <div class="reveal flex items-center gap-3 mb-5" style="opacity:0;transform:translateY(20px)">
  ...
  subgraph 输出层
    ...
    F4 --- O4[9]
      ...
      <!-- 第三章：核心概念 -->
      <!-- ================================================================ -->
      <section :id="chapters[2].id" class="pb-32 scroll-mt-32">
        <div class="text-center mb-10 reveal chapter-header" style="opacity:0;transform:translateY(30px)">
      ...
      <!-- 第四章：互动演示 -->
      <!-- ================================================================ -->
      <section :id="chapters[3].id" class="pb-20 scroll-mt-32">
      ...
      <!-- 底部引导 -->
      <div class="text-center pt-16 pb-8 reveal" style="opacity:0;transform:translateY(20px)">
