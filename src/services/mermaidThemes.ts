...
const lightVars: MermaidVars = {
  primaryColor:'#1D4ED8', primaryBorderColor:'#1E40AF', primaryTextColor:'#FDE68A',
  secondaryColor:'#E2E8F0', secondaryBorderColor:'#94A3B8', secondaryTextColor:'#8B6914',
  tertiaryColor:'#DBEAFE', tertiaryBorderColor:'#60A5FA', tertiaryTextColor:'#A07818',
  ...
  titleColor:'#8B6914', edgeLabelBackground:'#F1F5F9',
  darkMode:false, textColor:'#8B6914', labelTextColor:'#A07818',
  actorBorder:'#94A3B8', actorBkg:'#F1F5F9', actorTextColor:'#8B6914',
  actorLineColor:'#64748B', signalColor:'#8B6914', signalTextColor:'#8B6914',
  ...
  noteTextColor:'#A07818', loopTextColor:'#8B6914',
  sectionBkgColor:'#F1F5F9', sectionBkgColor2:'#E2E8F0',
  altSectionBkgColor:'#F8FAFC', altSectionBkgColor2:'#F1F5F9',
  taskBkgColor:'#1D4ED8', taskBorderColor:'#1E40AF', taskTextColor:'#FDE68A',
  taskTextLightColor:'#F8FAFC', taskTextDarkColor:'#8B6914',
  taskTextOutsideColor:'#A07818', taskTextClickableColor:'#8B6914',
  ...
  classText:'#8B6914', entityBorder:'#94A3B8',
  commitLabelColor:'#8B6914', commitLabelBackground:'#F1F5F9',
  tagLabelColor:'#8B6914', tagLabelBackground:'#CBD5E1', tagLabelBorder:'#94A3B8',
  ...
  pieTitleTextColor:'#8B6914', pieSectionTextColor:'#8B6914',
  pieLegendTextColor:'#A07818', pieStrokeColor:'#FFFFFF',
  labelColor:'#8B6914', altBackground:'#F1F5F9',
}
