...
const lightVars: MermaidVars = {
  ...
  secondaryColor:'#E2E8F0', secondaryBorderColor:'#94A3B8', secondaryTextColor:'#0F172A',
  tertiaryColor:'#DBEAFE', tertiaryBorderColor:'#60A5FA', tertiaryTextColor:'#1E40AF',
  ...
  darkMode:false, textColor:'#0F172A', labelTextColor:'#334155',
  actorBorder:'#94A3B8', actorBkg:'#F1F5F9', actorTextColor:'#0F172A',
  actorLineColor:'#64748B', signalColor:'#0F172A', signalTextColor:'#0F172A',
  ...
  noteTextColor:'#334155', loopTextColor:'#0F172A',
  ...
  taskTextOutsideColor:'#475569', taskTextClickableColor:'#1D4ED8',
  ...
  classText:'#0F172A', entityBorder:'#94A3B8',
  ...
  pieLegendTextColor:'#334155', pieStrokeColor:'#FFFFFF',
  labelColor:'#0F172A', altBackground:'#F1F5F9',
}

// ====== 护眼主题 ======
const sepiaVars: MermaidVars = {
  primaryColor:'#6B3410', primaryBorderColor:'#522808', primaryTextColor:'#FFFFFF',
  secondaryColor:'#E0D0B0', secondaryBorderColor:'#A89878', secondaryTextColor:'#2C1E0E',
  tertiaryColor:'#D4C0A0', tertiaryBorderColor:'#8B7D6B', tertiaryTextColor:'#522808',
  ...
  titleColor:'#2C1E0E', edgeLabelBackground:'#EBE0C8',
  darkMode:false, textColor:'#2C1E0E', labelTextColor:'#4A3828',
  actorBorder:'#A89878', actorBkg:'#EBE0C8', actorTextColor:'#2C1E0E',
  actorLineColor:'#6B5B48', signalColor:'#2C1E0E', signalTextColor:'#2C1E0E',
  ...
  noteTextColor:'#4A3828', loopTextColor:'#2C1E0E',
  sectionBkgColor:'#EBE0C8', sectionBkgColor2:'#E0D0B0',
  altSectionBkgColor:'#FBF6E8', altSectionBkgColor2:'#EBE0C8',
  taskBkgColor:'#6B3410', taskBorderColor:'#522808', taskTextColor:'#FFFFFF',
  taskTextLightColor:'#FBF6E8', taskTextDarkColor:'#2C1E0E',
  taskTextOutsideColor:'#5C4838', taskTextClickableColor:'#522808',
  ...
  classText:'#2C1E0E', entityBorder:'#A89878',
  commitLabelColor:'#2C1E0E', commitLabelBackground:'#EBE0C8',
  tagLabelColor:'#2C1E0E', tagLabelBackground:'#D4C0A0', tagLabelBorder:'#A89878',
  ...
  pieLegendTextColor:'#4A3828', pieStrokeColor:'#FBF6E8',
  labelColor:'#2C1E0E', altBackground:'#EBE0C8',
}
